...
const bloques: Bloque[] = [
  {
    ...
    intro:
      "Planificación y cumplimiento fiscal para autónomos, pymes y sociedades. Sin sustos en Hacienda.",
    items: [
  ...
  },
  {
    ...
    intro:
      "Contabilidad rigurosa y al día para tomar decisiones con datos reales, no con impresiones.",
    items: [
    ...
    <SiteLayout>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <span className="text-sm font-semibold text-white/85 uppercase tracking-[0.2em]">
            Servicios
          </span>
          <h1 className="mt-3 text-4xl md:text-6xl font-bold tracking-tight">
            Asesoría integral para tu negocio
          </h1>
          <p className="mt-5 max-w-2xl text-lg text-primary-foreground/80">
            Tres áreas de especialización para acompañarte en todo lo que tu actividad necesita,
            desde Antequera para toda Málaga.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <div className="relative order-2 md:order-1">
              ...
              <div className="absolute -bottom-6 -left-6 hidden md:flex items-center gap-3 rounded-2xl bg-primary text-primary-foreground px-6 py-4 shadow-elegant">
                ...
                <div>
                  <div className="text-xs uppercase tracking-widest text-brand-on-dark">
                    Tecnología
                  </div>
            ...
            <div className="order-1 md:order-2">
              ...
              <div className="mt-8 grid gap-5 sm:grid-cols-2">
                {[
                  {
                    i: Globe,
                    t: "Presencia digital corporativa",
                    d: "Sitios web profesionales orientados a conversión, posicionamiento y reputación de marca.",
                  },
                  {
                    i: Database,
                    t: "ERP, CRM y software de gestión",
                    d: "Implantación y desarrollo de sistemas adaptados a tus procesos reales de negocio.",
                  },
                  {
                    i: Workflow,
                    t: "Automatización de procesos",
                    d: "Eliminamos tareas repetitivas y conectamos tus herramientas para que el equipo se centre en lo importante.",
                  },
                  {
                    i: LineChart,
                    t: "Análisis y reporting",
                    d: "Cuadros de mando y métricas para tomar decisiones basadas en datos, no en intuiciones.",
                  },
                ].map(({ i: Icon, t, d }) => (
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-4">
          {[
            { n: "01", t: "Primera cita", d: "Nos reunimos contigo para entender tu situación." },
            {
              n: "02",
              t: "Propuesta",
              d: "Te presentamos un plan de servicios y honorarios claros.",
            },
            { n: "03", t: "Gestión", d: "Nos encargamos de todo: plazos, modelos y trámites." },
            {
              n: "04",
              t: "Acompañamiento",
              d: "Contacto directo durante todo el año, no solo en campañas.",
            },
          ].map((s) => (
