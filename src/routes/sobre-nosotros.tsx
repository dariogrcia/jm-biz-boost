    ...
    <SiteLayout>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <span className="text-sm font-semibold text-white/85 uppercase tracking-wider">Sobre nosotros</span>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 grid gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          <span className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Nuestra historia</span>
      ...
      <section className="bg-secondary/40 py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            <span className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Valores</span>
