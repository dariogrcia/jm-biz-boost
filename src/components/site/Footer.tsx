      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-5 max-w-sm text-sm text-primary-foreground/70 leading-relaxed">
            Asesoría fiscal, contable y laboral en Antequera (Málaga). Cerca de ti, contigo todo el
            año.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/70">
            ...
            <li>
              <Link to="/servicios" className="hover:text-brand-on-dark">
                Servicios
              </Link>
            </li>
            <li>
              <Link to="/sobre-nosotros" className="hover:text-brand-on-dark">
                Sobre nosotros
              </Link>
            </li>
            <li>
              <Link to="/blog" className="hover:text-brand-on-dark">
                Blog
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/70">
            ...
            <li className="flex items-start gap-2">
              ...
              <a href="mailto:jm_asesores@hotmail.com" className="hover:text-brand-on-dark">
